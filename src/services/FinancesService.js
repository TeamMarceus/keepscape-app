...
const FinancesService = {
  ...
  requestWithdraw: (body) => axios.post(`${BASE_URL}/seller/balance/withdrawals`, body , {
    headers: {
  ...
  updateWithdrawal: (id, body) => axios.put(`${BASE_URL}/admin/balance/withdrawals/${id}`, body, {
    headers: {
      'Content-Type': 'multipart/form-data',
    },
  }),
