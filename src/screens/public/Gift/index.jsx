...
function Gift({ id }) {
  ...
  return (
    ...
    >
      <div
        className={cn(styles.Gift_left, {
          [styles.Gift_left___negrosOriental]:
            place === 'Negros Oriental' && windowSize.width <= 991,
        })}
      >
        <Text
        ...
        >
          <span
            className={cn(styles.Gift_left_title_place, {
              [styles.Gift_left_title_place___negrosOriental]:
                place === 'Negros Oriental' && windowSize.width <= 575,
            })}
          >
            {place}
          </span>{' '}
          <span className={styles.Gift_left_title_text}>
            resides within you
          </span>
        </Text>
      ...
      <div className={styles.Gift_right}>
        ...
        <Card className={styles.Gift_right_card}>
          ...
          <Text colorClass={colorClasses.NEUTRAL['0']}>
            Create a Trip to save and organise all of your travel ideas, and see
            them on a map
          </Text>
