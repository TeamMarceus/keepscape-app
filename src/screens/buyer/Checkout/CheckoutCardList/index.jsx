...
import { Card, ControlledTextArea, Icon, Text } from '@/components';

import { textAreaTypes } from '../../../../components/TextArea/constants';

import styles from './styles.module.scss';

function CheckoutCardList({ className, userCart }) {
  return (
    <>
      {userCart.map(
        (cart) =>
              ...
              <div className={styles.CheckoutCardList}>
                ...
                {cart.cartItems.length > 0 &&
                  cart.cartItems.map((product) => (
                    <div
                      key={product.id}
                      className={styles.CheckoutCardList_item}
                    >
                      <div className={styles.CheckoutCardList_product}>
                        ...
                        <img
                          alt={product.name}
                          className={
                            styles.CheckoutCardList_product_details_image
                          }
                          height={60}
                        ...
                        <div>
                          <Text
                            className={
                              styles.CheckoutCardList_product_details_text
                            }
