...
function AddReviewModal({ isOpen, handleClose, productId }) {
  const { isLoading: isProductReviewLoading, productReview } =
    useProductReview(productId);
  const { isLoading: isAdding, addProductReview } = useAddProductReview();
  const { isLoading: isUpdating, updateProductReview } =
    useUpdateProductReview();
      ...
      {isProductReviewLoading ? (
        ...
        <Formik
          ...
          onSubmit={async (values, { setErrors }) => {
            ...
            if (!productReview?.id) {
              const { responseCode: addProductReviewResponseCode } =
                await addProductReview(productId, currentFormValues);
              ...
              const { responseCode: updateProductReviewResponseCode } =
                await updateProductReview(productId, currentFormValues);
          ...
          {({ errors, values, handleSubmit, setFieldValue }) => (
            <form onSubmit={handleSubmit}>
              ...
              <Button
                ...
                onClick={() => {}}
              >
                <span className={styles.AddReviewModal_button_buttonText}>
