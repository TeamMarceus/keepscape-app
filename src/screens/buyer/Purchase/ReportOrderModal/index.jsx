...
function ReportOrderModal({ isOpen, handleClose, title, orderId }) {
    ...
    >
      <Formik
        ...
        onSubmit={async (values, { setErrors }) => {
          ...
          const { responseCode: reportOrderResponseCode } = await reportOrder(
            orderId,
            currentFormValues
          );
        ...
        {({ errors, values, handleSubmit, setFieldValue }) => (
          <form onSubmit={handleSubmit}>
            ...
            <Button
              ...
              onClick={() => {}}
            >
              <span className={styles.ReportOrderModal_button_buttonText}>
                Submit
                {isSubmitting && (
                  <Spinner
