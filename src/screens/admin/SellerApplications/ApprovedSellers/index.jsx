  ...
  return (
    <>
      <div className={styles.ApprovedSellers}>
        <Text type={textTypes.HEADING.XS}>Approved Seller Applications</Text>
              ...
              <>
                      ...
                      windowSize.width > 767 ? (
                        ...
                        >
                          ...
                          <div className={styles.ApprovedSellers_grid_column}>
                            <IconButton
                              className={
                                styles.ApprovedSellers_grid_closeButton
                              }
                              icon="cancel"
                        ...
                        >
                          <summary
                            className={styles.ApprovedSellers_grid_title}
                          >
                            <div
                              className={styles.ApprovedSellers_grid_title_info}
                            >
                              <Icon
                                className={
                                  styles.ApprovedSellers_grid_title_icon
                                }
                                icon="expand_more"
                              />
                ...
                <Pagination
                  ...
                  pageJump={(value) => {
                    ...
                    router.push(
                      `/admin/seller-applications/approved?page=${value}`,
                      { scroll: false }
                    );
                  }}
