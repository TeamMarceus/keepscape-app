        ...
        {isOrdersLoading ? (
          ...
          <>
            {filteredOrders.length ? (
              <div className={styles.OnGoingOrders_grid}>
                {/* Header of OrderGrid starts here */}
                <Card
                  className={cn(
                    styles.OnGoingOrders_grid_orderGrid,
                    styles.OnGoingOrders_grid_headers
                  )}
                >
                  <div
                    className={cn(
                      styles.OnGoingOrders_grid_header,
                      styles.OnGoingOrders_grid_column
                    )}
                  >
                    Date Ordered
                  </div>
                  ...
                  <div
                    className={cn(
                      styles.OnGoingOrders_grid_header,
                      styles.OnGoingOrders_grid_column,
                      styles.OnGoingOrders_grid_header_action
                    )}
                  >
                    Actions
                  </div>
                ...
                {filteredOrders.map(
                  ({ id, dateOrdered, product, buyer, quantity, customization }) =>
                    windowSize.width > 767 ? (
                      // Desktop View
                      <Card key={id} className={styles.OnGoingOrders_grid_orderGrid}>
                        <div className={styles.OnGoingOrders_grid_column}>
                          {dateOrdered}
                        </div>

                        <ButtonLink 
                          className={cn(styles.OnGoingOrders_grid_column,
                            styles.OnGoingOrders_grid_column_product)}
                        ...
                        >
                          ...
                          <img
                            alt={product.name}
                            className={styles.OnGoingOrders_grid_column_product_image}
                            height={60}
                            src={product.image}
                            width={60}
                          />
                        ...
                        <div className={cn(styles.OnGoingOrders_grid_column,
                          styles.OnGoingOrders_grid_column_customization
                        )}>
                          {customization}
                        </div>
                      ...
                      <details
                        key={id}
                        className={styles.OnGoingOrders_grid_orderGrid}
                      >
                        <summary className={styles.OnGoingOrders_grid_title}>
                          <div className={styles.OnGoingOrders_grid_title_info}>
                            <Icon
                              className={styles.OnGoingOrders_grid_title_icon}
                              icon="expand_more"
                            />
