...
function OngoingOrders() {
  ...
  const [isAddDeliveryLogsModalOpen, setIsAddDeliveryLogsModalOpen] = useState(false);
  const [isDeliveryLogsModalOpen, setIsDeliveryLogsModalOpen] = useState(false);
  const [isBuyerModalOpen, setIsBuyerModalOpen] = useState(false);
  const [isDeliveredConfirmationToggled, toggleDeliveredConfirmation] = useState(false);
              ...
              <>
                      ...
                      windowSize.width > 767 ? (
                        ...
                        <Card key={id} className={styles.OngoingOrders_order}>
                          ...
                          <div className={styles.OngoingOrders_orderTotal}>
                            <div>
                              <div className={cn(styles.OngoingOrders_orderTotal_text, styles.OngoingOrders_orderTotal_text_fee)}>
                                <Text 
                                  colorClass={colorClasses.NEUTRAL['400']}
                                  type={textTypes.HEADING.XXXS}
                                >
                              ...
                              <div className={styles.OngoingOrders_orderTotal_text}>
                                <Text 
                                  colorClass={colorClasses.NEUTRAL['400']}
                                  type={textTypes.HEADING.XXS}
                                >
                            ...
                            <div className={styles.OngoingOrders_orderTotal_buttons}> 
                              <Button
                                className={styles.OngoingOrders_orderTotal_buttons_button}
                                disabled={false}
                                onClick={() => {
                                  setSelectedOrder({ id });
                ...
                <Pagination 
                  ...
                  pageJump={(value) => {
                    ...
                    router.push(`/seller/orders/on-going?page=${value}`, { scroll: false })
                  }}
