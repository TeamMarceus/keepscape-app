...
function Dashboard() {
  ...
  const { isLoading: isAnnouncementsLoading, announcements } = useAnnouncements(
    { page: 1, pageSize: 10 }
  );

  return (
    <div className={styles.Dashboard}>
      <Text type={textTypes.HEADING.XS}>Order Statistics</Text>
      ...
      <Text
        className={styles.Dashboard_announcementText}
      ...
      {isAnnouncementsLoading ? (
        ...
        announcements.map((announcement) => (
          <Card
            key={announcement.id}
            className={styles.Dashboard_announcements}
          >
